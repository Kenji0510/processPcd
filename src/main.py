...
def connect_ros(q_3JEDKBS001G9601, q_3JEDKC50014U011, q_3JEDL3N0015X621):
    ...
    rospy.Subscriber("/livox/lidar_tmp", PointCloud2, callback, ("tmp", q_3JEDKBS001G9601))
    rospy.Subscriber("/livox/lidar_tmp", PointCloud2, callback, ("tmp", q_3JEDKC50014U011))
    rospy.Subscriber("/livox/lidar_tmp", PointCloud2, callback, ("tmp", q_3JEDL3N0015X621))
    rospy.spin()
